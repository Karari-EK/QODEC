...
root_path=in_path
rootdir = in_path[0:25]
#print('Root Folder: '+rootdir)#'C:\pfiles\2007\Test Data\'
...
for subdir, dirs, files in os.walk(rootdir):
    ...
    for file in files:
        ...
        print("Folder...." + folder)
        out_path='C:\\pfiles\\2007\\Test Files\\'+folder+'\\'+in_file+'.txt'
        ...
        pp_out_path='C:\\pfiles\\2007\\PPFiles\\'+folder+'\\'+in_file+'.txt'
