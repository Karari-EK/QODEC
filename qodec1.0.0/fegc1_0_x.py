...
def temporal_dimension(ny,cy):
     return round(1/float(1+ny-cy),2)
...
if_path=easygui.fileopenbox()#obtain the path to the input file
...
for subdir, dirs, files in os.walk(rootdir):
     for file in files:
          ...
          with open(root_path,'r',encoding='UTF8') as fp:
               ...
               cy=float(root_path[28:32]) #obtain documents cy from file path-used in time dimension
               ...
               while line:
                    ...
                    if(input_str != ''):
                         ...
                         features_str=str(tf)+' '+str(sf)+' '+str(ss)+' '+str(td)+' '+str(sp)+' '+'\n'
          ...
          of_path='C:\\pfiles\\features\\'+in_folder+'\\'+in_file+'.txt'
